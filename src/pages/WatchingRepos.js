...
export default function WatchingRepos() {
  ...
  async function getWatchRepos() {
    startSpinner();
    axiosInstance.get(`/getWatchingRepos/${ORG_ID}`).then((getData) => {
  ...
  return (
    <Page title="Watching Repos | CSSMT">
      <Container>
              ...
              <Table>
                ...
                <TableBody>
                  {filteredRepos
                    ...
                    .map((row) => {
                      const { id, repoName, description, updatedAt, repoWatchStatus, createdAt, repoUrl } = row;
                        ...
                        >
                          ...
                          <TableCell component="th" scope="row" padding="none">
                            ...
                            <Typography
                                ...
                                to="/dashboard/repo"
                                state={{ name: repoName, descript: description, url: repoUrl }}
                              >
                                {repoName}
                              </Typography>
                            </Stack>
